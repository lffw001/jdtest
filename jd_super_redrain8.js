...
[task_local]
#整点京豆雨
1 0-23/1 * * * https://github.com/libinxwz/jdtest/jd_super_redrain8.js, tag=整点京豆雨, enabled=true

================Loon==============
[Script]
cron "0 0-23/1 * * *" script-path=https://github.com/libinxwz/jdtest/jd_super_redrain8.js,tag=整点京豆雨

===============Surge=================
 整点京豆雨 = type=cron,cronexp="1 0-23/1 * * *",wake-system=1,timeout=20,script-path=https://github.com/libinxwz/jdtest/jd_super_redrain8.js

============小火箭=========
 整点京豆雨= type=cron,script-path=https://github.com/libinxwz/jdtest/jd_super_redrain8.js, cronexpr="1 0-23/1 * * *",timeout=200, enable=true
 */
const $ = new Env('整点京豆雨');
let allMessage = '';
let bodyList = {
