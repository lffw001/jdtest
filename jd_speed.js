/*
京东天天加速链接：https://github.com/libinxwz/jdtest/jd_speed.js
更新时间：2020-12-25
...
[task_local]
#天天加速
8 0-23/3 * * * https://github.com/libinxwz/jdtest/jd_speed.js, tag=京东天天加速, enabled=true

============Loon================
[Script]
cron "8 0-23/3 * * *" script-path=https://github.com/libinxwz/jdtest/jd_speed.js,tag=京东天天加速

===========Surge============
天天加速 = type=cron,cronexp="8 0-23/3 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtest/jd_speed.js

==============小火箭=============
天天加速 = type=cron,script-path=https://github.com/libinxwz/jdtest/jd_speed.js, cronexpr="11 0-23/3 * * *", timeout=3600, enable=true
*/
