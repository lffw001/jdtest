...
[task_local]
#京东极速版红包
20 1,2-23/4 * * * https://github.com/libinxwz/jdtest/jd_speed_sign.js, tag=京东极速版红包, enabled=true

================Loon==============
[Script]
cron "20 1,2-23/4 * * *" script-path=https://github.com/libinxwz/jdtest/jd_speed_sign.js,tag=京东极速版红包

===============Surge=================
京东极速版红包 = type=cron,cronexp="20 1,2-23/4 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtest/jd_speed_sign.js

============小火箭=========
京东极速版红包 = type=cron,script-path=https://github.com/libinxwz/jdtest/jd_speed_sign.js, cronexpr="20 1,2-23/4 * * *", timeout=3600, enable=true
*/
const $ = new Env('京东极速版');
