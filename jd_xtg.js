...
[task_local]
#家电星推官
0 0 0 * * * https://github.com/libinxwz/jdtestjd_xtg.js, tag=家电星推官, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "0 0 0 * * *" script-path=https://github.com/libinxwz/jdtestjd_xtg.js,tag=家电星推官

===============Surge=================
家电星推官 = type=cron,cronexp="0 0 0 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtestjd_xtg.js

============小火箭=========
家电星推官 = type=cron,script-path=https://github.com/libinxwz/jdtestjd_xtg.js, cronexpr="0 0 0 * * *", timeout=3600, enable=true
 */
const $ = new Env("家电星推官");
