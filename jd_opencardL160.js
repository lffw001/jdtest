...
第一个CK失效会退出脚本
————————————————
入口：[ 5.27-6.1 我的新家 超级配 ]

请求太频繁会被黑ip
过10分钟再执行

cron:41 10,16,20 27-31 5 *
============Quantumultx===============
[task_local]
#5.27-6.1 我的新家 超级配
41 10,16,20 27-31 5 * jd_opencardL160.js, tag=5.27-6.1 我的新家 超级配, enabled=true
...
!(async () => {
  ...
  $.activityId = "dzlhkkde5c0b4e3c90bdb208688e7c"
  $.shareUuid = "5de45375db254fd6946e00509d457ff3"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = ["5de45375db254fd6946e00509d457ff3","528c3b66d5a94cf38684ee4e8c43ca78"]
