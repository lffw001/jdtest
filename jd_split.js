...
[task_local]
#金榜年终奖
10 1,2 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_split.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "10 1,2 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_split.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="10 1,2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_split.js

============小火箭=========
金榜年终奖 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_split.js, cronexpr="10 1,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终奖');
...
$.shareCodes = ["T0114qQhGUBRsh4CjRQmoaX5kRrbA","T0225KkcRh9N8AKBcx3zxaFYJwCjRQmoaX5kRrbA","T019-akzE355iBGldUSs76ACjRQmoaX5kRrbA"];
!(async () => {
  if (!cookiesArr[0]) {
