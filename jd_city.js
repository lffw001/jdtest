...
const author_codes = ['_LGpAPJEIS4PLxKIBsq14w','-ryUX61YYzIVMBXDG42XpOfGwgOYHXJ8','57y7CsxsGyExNkycMYyJu7o6VAGX5Q','-ryUXqwNb2UXYUaRGNqW9ReF2rDaUruk'].sort(() => 0.5 - Math.random())
const self_code = []
let pool = []
!(async () => {
