...
[task_local]
#取关京东店铺商品
55 23 * * * https://github.com/libinxwz/jdtest/jd_unsubscribes.js, tag=取关京东店铺商品, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon============
[Script]
cron "55 23 * * *" script-path=https://github.com/libinxwz/jdtest/jd_unsubscribes.js,tag=取关京东店铺商品
============Surge=============
取关京东店铺商品 = type=cron,cronexp="55 23 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtest/jd_unsubscribes.js
===========小火箭========
取关京东店铺商品 = type=cron,script-path=https://github.com/libinxwz/jdtest/jd_unsubscribes.js, cronexpr="55 23 * * *", timeout=3600, enable=true
 */
