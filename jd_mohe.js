...
[task_local]
#5G超级盲盒
0 0,1-23/3 * * * https://github.com/libinxwz/jdtestjd_mohe.js, tag=5G超级盲盒, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "0 0,1-23/3 * * *" script-path=https://github.com/libinxwz/jdtestjd_mohe.js,tag=5G超级盲盒

===================================Surge================================
5G超级盲盒 = type=cron,cronexp="0 0,1-23/3 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtestjd_mohe.js

====================================小火箭=============================
5G超级盲盒 = type=cron,script-path=https://github.com/libinxwz/jdtestjd_mohe.js, cronexpr="0 0,1-23/3 * * *", timeout=3600, enable=true
 */
...
//邀请码一天一变化，已确定
$.shareId = ['b618b1ef-82b2-4224-9c78-22e8187070f3','20b6dcaf-7494-4327-929f-795dd3b01c60','583a8006-c3de-476e-b709-516b99bdc655','690d69cb-173c-437e-bdc0-4bf8d0c02b4c','ec6879ef-bfac-4f8e-a4b3-469cc52224c7','9dc3a323-ea5d-4125-8add-83b0f2ea639d','3e401ce4-e092-482b-a686-d3f3320d7720','adf47249-1231-47e2-962a-9d09f779e481'];
!(async () => {
  if (!cookiesArr[0]) {
