...
京东超级盒子
活动时间：未知
更新地址：https://github.com/libinxwz/jdtest/jd_superbox.js
...
[task_local]
#京东超级盒子
20 7 * * * https://github.com/libinxwz/jdtest/jd_superbox.js, tag=京东超级盒子, enabled=true
================Loon==============
[Script]
cron "20 7 * * *" script-path=https://github.com/libinxwz/jdtest/jd_superbox.js,tag=京东超级盒子
===============Surge=================
京东超级盒子 = type=cron,cronexp="20 7 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtest/jd_superbox.js
============小火箭=========
京东超级盒子 = type=cron,script-path=https://github.com/libinxwz/jdtest/jd_superbox.js, cronexpr="20 7 * * *", timeout=3600, enable=true
*/
...
if ($.isNode()) {
  ...
  if (JSON.stringify(process.env).indexOf('GITHUB1111') > -1) process.exit(0)
} else {
