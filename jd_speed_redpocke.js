...
[task_local]
#京东极速版红包
0 0,22 * * * https://github.com/libinxwz/jdtestjd_speed_redpocke.js, tag=京东极速版红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "0 0,22 * * *" script-path=https://github.com/libinxwz/jdtestjd_speed_redpocke.js,tag=京东极速版红包

===============Surge=================
京东极速版红包 = type=cron,cronexp="0 0,22 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtestjd_speed_redpocke.js

============小火箭=========
京东极速版红包 = type=cron,script-path=https://github.com/libinxwz/jdtestjd_speed_redpocke.js, cronexpr="0 0,22 * * *", timeout=3600, enable=true
*/
