...
cron:10 10,12,16,22 15-20 6 *
============Quantumultx===============
[task_local]
#6.13-6.20 时尚狂欢盛典
10 10,12,16,22 15-20 6 * jd_opencardL187.js, tag=6.13-6.20 时尚狂欢盛典, enabled=true
...
!(async () => {
  ...
  $.shareUuid = "3041d7d10f3449d0abc396004bd278c1"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/june/fashionUnion/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = ["3041d7d10f3449d0abc396004bd278c1","0376b6afadbc4604b6afd1723f5dd9c5"]
