...
ddnc_help_list = ["libinxwz", "jd_61d5ffc77afbc", "wdpcPPMuBenhKg","jd_53504250c5652","jd_70b6936fd65a9","jd_uhQrHvOnkruH","wdFulrsXNvpcbf"]
...
class msg(object):
    ...
    def getsendNotify(self, a=0):
        if a == 0:
            a += 1
        try:
            url = ' https://ghproxy.com/https://raw.githubusercontent.com/acoolbook/lxkwz/main/sendNotify.py'
