...
[task_local]
#京东手机狂欢城
0 0-18/3 * * * https://github.com/libinxwz/jdtestjd_carnivalcity.js, tag=京东手机狂欢城, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "0 0-18/6 * * *" script-path=https://github.com/libinxwz/jdtestjd_carnivalcity.js, tag=京东手机狂欢城

====================Surge================
京东手机狂欢城 = type=cron,cronexp=0 0-18/6 * * *,wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtestjd_carnivalcity.js

============小火箭=========
5G狂欢城 = type=cron,script-path=https://github.com/libinxwz/jdtestjd_carnivalcity.js, cronexpr="0 0,6,12,18 * * *", timeout=3600, enable=true
*/
...
if ($.isNode()) {
  ...
  if (JSON.stringify(process.env).indexOf('GITHUB111') > -1) process.exit(0)
} else {
  cookiesArr = [$.getdata('CookieJD'), $.getdata('CookieJD2'), ...jsonParse($.getdata('CookiesJD') || "[]").map(item => item.cookie)].filter(item => !!item);
}
let inviteCodes = ["87388e95-a9cd-4fe7-97b1-5b0d0c187340@8ed83710-5f3d-409c-9965-f2faff553e31@65c9598d-87a6-4a05-b550-84606ec8c5a8@905f8b63-fc80-4289-b544-76527acd5e99@de4ac959-5ae7-4b36-8093-7b35c97eb6c9@963e69d1-ae74-4857-a373-f101663b160c@f4bd978f-a473-4da1-a7eb-a1e3f4cab07a@c786d95f-dfdb-4fd0-a457-114b8028b40c",
"87388e95-a9cd-4fe7-97b1-5b0d0c187340@8ed83710-5f3d-409c-9965-f2faff553e31@65c9598d-87a6-4a05-b550-84606ec8c5a8@905f8b63-fc80-4289-b544-76527acd5e99@de4ac959-5ae7-4b36-8093-7b35c97eb6c9@963e69d1-ae74-4857-a373-f101663b160c@f4bd978f-a473-4da1-a7eb-a1e3f4cab07a@c786d95f-dfdb-4fd0-a457-114b8028b40c",
"87388e95-a9cd-4fe7-97b1-5b0d0c187340@8ed83710-5f3d-409c-9965-f2faff553e31@65c9598d-87a6-4a05-b550-84606ec8c5a8@905f8b63-fc80-4289-b544-76527acd5e99@de4ac959-5ae7-4b36-8093-7b35c97eb6c9@963e69d1-ae74-4857-a373-f101663b160c@f4bd978f-a473-4da1-a7eb-a1e3f4cab07a@c786d95f-dfdb-4fd0-a457-114b8028b40c",
"87388e95-a9cd-4fe7-97b1-5b0d0c187340@8ed83710-5f3d-409c-9965-f2faff553e31@65c9598d-87a6-4a05-b550-84606ec8c5a8@905f8b63-fc80-4289-b544-76527acd5e99@de4ac959-5ae7-4b36-8093-7b35c97eb6c9@963e69d1-ae74-4857-a373-f101663b160c@f4bd978f-a473-4da1-a7eb-a1e3f4cab07a@c786d95f-dfdb-4fd0-a457-114b8028b40c",
"87388e95-a9cd-4fe7-97b1-5b0d0c187340@8ed83710-5f3d-409c-9965-f2faff553e31@65c9598d-87a6-4a05-b550-84606ec8c5a8@905f8b63-fc80-4289-b544-76527acd5e99@de4ac959-5ae7-4b36-8093-7b35c97eb6c9@963e69d1-ae74-4857-a373-f101663b160c@f4bd978f-a473-4da1-a7eb-a1e3f4cab07a@c786d95f-dfdb-4fd0-a457-114b8028b40c",
...
function updateShareCodesCDN(url = 'https://cdn.jsdelivr.net/gh/wuzhi-docker1/updateTeam@master/shareCodes/jd_cityShareCodes.json') {
  return new Promise(resolve => {
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: `https://cdn.jsdelivr.net/gh/wuzhi-docker1/updateTeam@master/shareCodes/jd_cityShareCodes.json`, 'timeout': 20000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
