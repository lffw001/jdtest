...
[task_local]
#京东保价
0 2 * * * https://github.com/libinxwz/jdtestjd_price.js, tag=京东保价, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "0 2 * * *" script-path=https://github.com/libinxwz/jdtestjd_price.js,tag=京东保价

===============Surge=================
京东保价 = type=cron,cronexp="0 2 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtestjd_price.js

============小火箭=========
京东保价 = type=cron,script-path=https://github.com/libinxwz/jdtestjd_price.js, cronexpr="0 2 * * *", timeout=3600, enable=true
 */
