...
function getLottery() {
  ...
  return new Promise(resolve => {
    $.get(taskUrl3("knowledge/8972/lottery?rdm="+Math.random(), body), async (err, resp, data) => {
      try {
        if (err) {
