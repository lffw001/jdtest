...
var cookieList=[
	...
	//圈圈
	"227c6de2e69df53c21d22e4e225757e6",
	"7b112045a3a430c9ee9fa59a4bfe8262",
	"c2eab4fe2963f4c20b94f16c33399212",
	"55e94b87acce0743a92cdb3186ab49fa",
...
!(async () => {
	...
	for(var i=0;i<cookieList.length;i++){
		...
		await getCiShu();	
		if($.times>1){
			$.time=11+Math.floor(Math.random()*2);
			await getQuestion();	
