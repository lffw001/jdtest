...
更新地址：https://github.com/libinxwz/jdtestjd_xgyl.js
...
[task_local]
#小鸽有礼2
30 7 * * * https://github.com/libinxwz/jdtestjd_xgyl.js, tag=小鸽有礼2, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_xgyl.png, enabled=true

================Loon==============
[Script]
cron "30 7 * * *" script-path=https://github.com/libinxwz/jdtestjd_xgyl.js, tag=小鸽有礼2

===============Surge=================
小鸽有礼2 = type=cron,cronexp="30 7 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtestjd_xgyl.js

============小火箭=========
小鸽有礼2 = type=cron,script-path=https://github.com/libinxwz/jdtestjd_xgyl.js, cronexpr="30 7 * * *", timeout=3600, enable=true
 */
const $ = new Env('小鸽有礼2');
