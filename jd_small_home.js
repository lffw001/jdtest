 ...
 */
/*
东东小窝 https://github.com/libinxwz/jdtestjd_small_home.js
现有功能：
...
[task_local]
#东东小窝
16 22 * * * https://github.com/libinxwz/jdtestjd_small_home.js, tag=东东小窝, img-url=https://raw.githubusercontent.com/58xinian/icon/master/ddxw.png, enabled=true

================Loon==============
[Script]
cron "16 22 * * *" script-path=https://github.com/libinxwz/jdtestjd_small_home.js, tag=东东小窝

===============Surge=================
东东小窝 = type=cron,cronexp="16 22 * * *",wake-system=1,timeout=3600,script-path=https://github.com/libinxwz/jdtestjd_small_home.js

============小火箭=========
东东小窝 = type=cron,script-path=https://github.com/libinxwz/jdtestjd_small_home.js, cronexpr="16 22 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东小窝');
...
!(async () => {
  ...
  await updateInviteCodeCDN('https://raw.githubusercontent.com/269569205/jdupdateTeam/master/shareCodes/jd_updateSmallHomeInviteCode.json');
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      cookie = cookiesArr[i];
      $.token = $.helpToken[i];
...
function updateInviteCode(url = 'https://raw.githubusercontent.com/269569205/jdupdateTeam/master/shareCodes/jd_updateSmallHomeInviteCode.json') {
  return new Promise(resolve => {
